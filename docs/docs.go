        ...
        "/basket": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Basket item details (e.g., quantity)",
                        "name": "item",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "main.Item": {
            ...
            "properties": {
                ...
                "name": {
                    "description": "Itemid        string  ` + "`" + `gorm:\"primaryKey;column:item_id\" json:\"item_id\"` + "`" + `",
                    "type": "string"
                },
                "price": {
                    "type": "integer"
        ...
        "main.Order": {
            ...
            "properties": {
                ...
                "final_price": {
                    "description": "TimeDelivery    string  ` + "`" + `gorm:\"column:timedelivery\" json:\"time_delivery\"` + "`" + ` // или time.Time если используешь TIME тип",
                    "type": "number"
                },
                "number_kilometer": {
                    "type": "number"
                ...
                "order_date": {
                    "description": "можно time.Time, если используешь time пакет",
                    "type": "string"
                },
                "order_id": {
                    "type": "integer"
        ...
        "main.OrderItem": {
            ...
            "properties": {
                ...
                "order_id": {
                    "description": "OrderItemid   string  ` + "`" + `gorm:\"primaryKey;column:orderitem_id\" json:\"orderitem_id\"` + "`" + `",
                    "type": "integer"
                },
                "package_id": {
                    "type": "string"
